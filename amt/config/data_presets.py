...
from amt.config.vocabulary import *
from amt.config.vocabulary import drum_vocab_presets, program_vocab_presets
from amt.utils.utils import deduplicate_splits, merge_splits, merge_vocab
...
data_preset_single_cfg = {
    ...
    "guitarset_progression": {  # progression 1 and 2 as train, progression 3 as test
        "eval_vocab": [GUITAR_SOLO_CLASS],
        "dataset_name": "guitarset",
        "train_split": merge_splits(
            ["progression_1", "progression_2"], dataset_name="guitarset"
        ),
    ...
    "guitarset_progression_pshift": {  # guuitarset_progression + pitch shift
        ...
        "dataset_name": "guitarset",
        "train_split": merge_splits(
            ["progression_1_pshift", "progression_2_pshift"], dataset_name="guitarset"
        ),
        "validation_split": "progression_3",
        "test_split": "progression_3",
        "has_stem": False,
    ...
    "guitarset_minus_bn": {  # guuitarset_style + pitch shift
        ...
        "dataset_name": "guitarset",
        "train_split": merge_splits(
            ["Funk_pshift", "SS_pshift", "Jazz_pshift", "Rock_pshift"],
            dataset_name="guitarset",
        ),
        "validation_split": "BN",
        "test_split": "BN",
    ...
    "guitarset_minus_funk": {  # guuitarset_style + pitch shift
        ...
        "dataset_name": "guitarset",
        "train_split": merge_splits(
            ["BN_pshift", "SS_pshift", "Jazz_pshift", "Rock_pshift"],
            dataset_name="guitarset",
        ),
    ...
    "guitarset_minus_ss": {  # guuitarset_style + pitch shift
        ...
        "dataset_name": "guitarset",
        "train_split": merge_splits(
            ["BN_pshift", "Funk_pshift", "Jazz_pshift", "Rock_pshift"],
            dataset_name="guitarset",
        ),
        "validation_split": "SS",
        "test_split": "SS",
    ...
    "guitarset_minus_jazz": {  # guuitarset_style + pitch shift
        ...
        "dataset_name": "guitarset",
        "train_split": merge_splits(
            ["BN_pshift", "Funk_pshift", "SS_pshift", "Rock_pshift"],
            dataset_name="guitarset",
        ),
    ...
    "guitarset_minus_rock": {  # guuitarset_style + pitch shift
        ...
        "dataset_name": "guitarset",
        "train_split": merge_splits(
            ["BN_pshift", "Funk_pshift", "SS_pshift", "Jazz_pshift"],
            dataset_name="guitarset",
        ),
    ...
    "enstdrums_dtp": {
        ...
        "train_split": merge_splits(
            ["drummer_1_dtp", "drummer_2_dtp", "drummer_1_dtp", "drummer_2_dtp"],
            dataset_name="enstdrums",
        ),
    ...
    "enstdrums_dtm": {
        ...
        "dataset_name": "enstdrums",
        "train_split": merge_splits(
            ["drummer_1_dtm", "drummer_2_dtm", "drummer_1_dtp", "drummer_2_dtp"],
            dataset_name="enstdrums",
        ),
...
data_preset_multi_cfg = {
    ...
    "all_mmegs": {
        ...
        "eval_drum_vocab": drum_vocab_presets[
            "ksh"
        ],  # for drums, kick-snare-hihat metric
    ...
    "singing_v1": {  # slakh + mir_st500 without spleeter
        ...
        "eval_vocab": [
            None,
            SINGING_SOLO_CLASS,
        ],  # None means instrument-agnostic F1 for each dataset
        "eval_drum_vocab": drum_vocab_presets[
            "ksh"
        ],  # for drums, kick-snare-hihat metric
        "val_max_num_files": 20,  # max 20 files per dataset
    ...
    "all_eval_final": {  # The final evaluation set
        "presets": [
            ...
            "urmp",
            "maps_default",
            "rwc_pop_full",  # "geerdes", "geerdes_sep",
        ],
        "eval_vocab": [
            GM_INSTR_CLASS,
            ...
            GM_INSTR_CLASS,
            PIANO_SOLO_CLASS,
            GM_INSTR_CLASS_PLUS,  # GM_INSTR_CLASS_PLUS, GM_INSTR_CLASS_PLUS
        ],
        "eval_drum_vocab": drum_vocab_presets["ksh"],
    },
