...
from amt.utils.utils import download_and_extract
from amt.utils.utils import get_checksum
from amt.utils.utils import merge_file_lists
from amt.utils.utils import reindex_file_list_keys
from amt.utils.utils import remove_ids_from_file_list
from amt.utils.utils import deduplicate_splits
...
class TestMergeFileListFunctions(unittest.TestCase):
    ...
    def test_remove_ids_from_file_list(self):
        file_list = {
            "a": {"music_id": 123, "name": "file1"},
            "b": {"music_id": 222, "name": "file2"},
        }
        selected_ids = [123]
...
class TestDeduplicateSplits(unittest.TestCase):
    ...
    def test_deduplicate_splits(self):
        ...
        file_list_a = {
            "split1": {"some_id": 1, "file_name": "a.jpg"},
            "split2": {"some_id": 2, "file_name": "b.jpg"},
            "split3": {"some_id": 3, "file_name": "c.jpg"},
        }
        file_list_b = {
            "split4": {"some_id": 2, "file_name": "d.jpg"},
            "split5": {"some_id": 3, "file_name": "e.jpg"},
            "split6": {"some_id": 6, "file_name": "f.jpg"},
        }

        # Remove duplicates between split A and split B
        filtered_file_list_a = deduplicate_splits(
            file_list_a, file_list_b, reindex=False
        )
