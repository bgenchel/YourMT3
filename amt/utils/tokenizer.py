...
from amt.utils.note_event_dataclasses import Event, EventRange, Note  # , Codec
from amt.utils.event_codec import FastCodec as Codec
from amt.utils.note_event_dataclasses import NoteEvent
...
class NoteEventTokenizer(EventTokenizerBase):
    ...
    def decode(
        ...
        if self.debug_mode:
            ...
            logger.info('%s', ignored_tokens_from_input)
