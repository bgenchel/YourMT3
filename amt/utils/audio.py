...
def pitch_shift_audio(src_audio_file: os.PathLike,
    ...
    try:
        ...
        logger.info('%s', f"Failed to load audio file: {src_audio_file}. {e}")
        return
    ...
    for pitch_shift in range(min_pitch_shift, max_pitch_shift):
        ...
        try:
            ...
            logger.info('%s', f"Created {dst_audio_file}")
        except subprocess.CalledProcessError as e:
            logger.info('%s', f"Failed to pitch shift audio file: {src_audio_file}, pitch_shift: {pitch_shift}. {e}")
