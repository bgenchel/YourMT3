...
from amt.model.perceiver_helper import MoEModelOutputWithCrossAttentions
from amt.model.perceiver_helper import PerceiverTFPreTrainedModel, PerceiverTFConfig
from amt.model.positional_encoding import AlibiPositionalBias, get_rotary_emb
from amt.model.ops import get_layer_norm
from amt.model.ff_layer import get_ff_layer
...
def test():
    ...
    for pe_type in pe_types:
        config.position_encoding_type = (
            pe_type  # 'alibi', 'alibit', 'trainable', 'tkd', 'td', 'tk', 'kdt', None
        )
        ...
        logger.info('%s %s', config.position_encoding_type, f"num_param: {n_param}K")
    """
    PE type | num. param.
    None | 1397K
    alibi | 1397K
