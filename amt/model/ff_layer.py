...
from amt.model.ops import optional_compiler_disable, optional_compiler_dynamic
...
def test_get_ff_layer():
    ...
    logger.info('%s %s', hidden_states.shape, router_logits.shape)  # (2, 8, 32), (2*8, 4)
    ...
    logger.info('%s', hidden_states.shape)  # (2, 8, 32)
