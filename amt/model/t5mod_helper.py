...
from amt.model.t5mod import T5DecoderYMT3, MultiChannelT5Decoder
    ...
    for i in range(max_length - prefix_length - 1):  # -1 for <eos> token
        if debug:
            past_key_values_length = past_key_values[0][0].shape[
                2
            ]  # past_key_values_length determines the positional embedding
            logger.info('%s', f"i = {i}, past_key_values_length = {past_key_values_length}, pred_ids.shape = {pred_ids.shape}")
